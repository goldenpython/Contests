...
int main() {
	...
	while (std::cin >> nN) {
		...
		// from : http://mathworld.wolfram.com/Bracketing.html, http://mathworld.wolfram.com/BinaryBracketing.html
		BigInteger oSol(GetSuperCatalan<BigInteger>(oVecPrimes, nN));
		oSol -= GetCatalan<BigInteger>(oVecPrimes, nN);
